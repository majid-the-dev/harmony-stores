...
const Footer = () => {
  const date = new Date();
  return (
    // <footer className="bg-gray-100/90 mx-auto px-6 pt-24">
    //   <div className="flex flex-col items-center justify-center">
    //     <h1 className="text-center text-white text-xl md:text-2xl font-semibold">
    //       Subscribe to our Newsletter
    //     </h1>
    //     <p className="text-center text-gray-500 text-xs mt-4 leading-5">
    ...
    //         width={100}
    //       />
    //       <p className="text-gray-500 text-xs leading-5 max-w-md mt-6">
    ...
    //           width={20}
    //         />
    //         <span className="text-gray-500 text-xs max-w-sm leading-5">
    //           HIS GRACE PLAZA, 4 FRANCIS OREMEJI STREET, OFF SIMBIAT ABIOLA WAY,
    //           IKEJA, LAGOS
    //         </span>
    //       </div> */}
    //       {/* <p className="text-gray-500 text-xs flex items-center gap-2.5 mt-5">
    //         <span>
    //           <BsFillTelephoneFill />
    //         </span>
    //         +2348077286191
    //       </p>
    //       <p className="text-gray-500 text-xs flex items-center gap-2.5 mt-4">
    //         <span>
    //           <IoMail />
    //         </span>
    ...
    //           <Link
    //             href={"/"}
    //             className="animation text-gray-500 text-xs hover:translate-x-2"
    //           >
    //             Home
    //           </Link>
    //           <Link
    ...
    //             target="_blank"
    //             href={
    //               "https://www.tiktok.com/@harmonygroupng?is_from_webapp=1&sender_device=pc"
    //             }
    //             className="animation text-gray-500 text-xs hover:translate-x-2"
    //           >
    //             TikTok
    ...
    //     <p className="text-gray-500 text-xs text-center leading-8">
    //       Copyright &copy; {date.getFullYear()} Harmony Group NG. <br /> All
    //       rights reserved.
    //     </p>
    //   </div>
    // </footer>
    ...
    //     <div className="grid grid-cols-2 md:grid-cols-3 border-b border-gray-300/70 pb-14">
    //       <div className="col-span-2 md:col-span-1">
    //         <h3 className="text-gray-900 text-base font-bold text-center md:text-left">
    //           Get in touch with us
    //         </h3>
    //         <p className="text-gray-600 text-[13px] text-center md:text-left mt-1">
    ...
    //               <p className="text-gray-900 text-sm font-bold">Head store</p>
    //               <p className="text-[13px] text-gray-600">
    //                 Unit L17, Ikeja City Mall, Lagos
    //               </p>
    //             </div>
    //           </div>
    //           <div className="flex items-center gap-2">
    ...
    //               <p className="text-[13px] text-gray-600">+234 8077286191</p>
    //             </div>
    //           </div>
    //           <div className="flex items-center gap-2">
    //             {/* <div className="border border-gray-300 rounded-full p-3">
    ...
    //             </div> */}
    //             <div className="flex flex-col gap-2">
    //               <p className="text-gray-900 text-sm font-bold">Hours</p>
    //               <p className="text-[13px] text-gray-600">8AM - 10PM</p>
    //             </div>
    //           </div>
    //         </div>
    //       </div>
    ...
    //     <div className="grid grid-cols-2 md:grid-cols-4 gap-10 w-full mt-14">
    //       <div className="col-span-1">
    //         <h1 className="text-gray-900 text-sm font-bold whitespace-nowrap">
    //           Quick Links
    //         </h1>
    //         <div className="flex flex-col gap-3 mt-5">
    //           <Link
    //             href={"/"}
    //             className="animation text-gray-600 text-[13px] hover:translate-x-2 hover:text-gray-900 hover:font-semibold"
    //           >
    //             Home
    //           </Link>
    //           <Link
    ...
    //           <Link
    //             href={"/profile"}
    //             className="animation text-gray-600 text-[13px] hover:translate-x-2"
    //           >
    //             Profile
    //           </Link>
    //           <Link
    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="text-gray-600 text-[13px] mt-4">
              At Harmony stores, we strive to meet and exceed <br /> customer
              expectations
            </p>
        ...
        <p className="text-xs text-gray-500">
          &copy; 2025. Harmony Stores NG. All rights reserved.
        </p>
      </div>
    </footer>
  );
