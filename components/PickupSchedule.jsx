...
const PickupSchedule = ({ pickupSchedule, setPickupSchedule, setPickupLocation }) => {
  return (
    <div className="flex flex-col bg-white border border-gray-200 rounded-lg p-7 mt-8">
      ...
      <input
        ...
        className="w-full bg-gray-100 text-sm font-semibold rounded-lg p-3 mt-3 outline-none"
      />
