...
const DeliveryInformation = ({
  ...
  return (
    <div>
      <div className="flex flex-col gap-6 bg-white border border-gray-200 rounded-lg p-7 mt-8">
        ...
        <div className="flex flex-col gap-3 w-full">
          <label className="text-xs text-gray-500 font-normal">Email</label>
          <input
            type="email"
            value={email}
        ...
        <div className="flex flex-col gap-3 w-full">
          <label className="text-xs text-gray-500 font-normal">City</label>
          <input
            type="text"
            value={city}
      ...
      <div className="flex flex-col bg-white border border-gray-200 rounded-lg p-7 mt-8">
        <h1 className="text-sm font-semibold">Additional Information</h1>
        <label className="text-xs text-gray-500 font-normal mt-1.5">
        ...
        <textarea
          ...
          className="bg-gray-100 text-sm font-semibold rounded-lg px-3 py-3 outline-none mt-7"
        ></textarea>
      </div>
    </div>
  );
