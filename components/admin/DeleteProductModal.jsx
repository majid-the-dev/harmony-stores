...
const DeleteProductModal = ({ setIsModal, onDelete }) => {
  ...
  return (
    <>
        <div onClick={() => setIsModal(false)} className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 px-6">
            <div onClick={(e) => e.stopPropagation()} className="bg-white w-full max-w-lg flex flex-col items-center justify-center rounded-lg p-7">
                ...
                <p className="w-full max-w-sm text-center text-gray-500 leading-5 mt-2">You are about to delete a product. This action cannot be reversed.</p>
                <div className="flex items-center gap-3 mt-5">
                <button onClick={() => setIsModal(false)} className="text-gray-500 border border-gray-300 rounded-lg px-6 py-3">Cancel</button>
